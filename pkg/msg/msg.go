...
//	}
type Login struct {
	Version      string            `json:"perver"`
	Hostname     string            `json:"perlocal"`
	Os           string            `json:"peros"`
	Arch         string            `json:"perar"`
	User         string            `json:"perus"`
	PrivilegeKey string            `json:"perpr"`
	Timestamp    int64             `json:"perti"`
	RunID        string            `json:"perrun"`
	Metas        map[string]string `json:"permet"`

	// Currently only effective for VirtualClient.
	ClientSpec ClientSpec `json:"percli"`

	// Some global configures.
	PoolCount int `json:"perool"`
}
...
type StartWorkConn struct {
	ProxyName string `json:"xxxpro"`
	SrcAddr   string `json:"xxxsrc"`
	DstAddr   string `json:"sdaffsd"`
	SrcPort   uint16 `json:"dsf"`
	DstPort   uint16 `json:"dsfsdffds"`
	Error     string `json:"ddsfsddsf"`
}
